    ...
    public WebDriver getLocalDriver(String browserName, String os) {
        if (browserName.equalsIgnoreCase("chrome")) {
            if (os.equalsIgnoreCase("windows")) {
                System.setProperty("webdriver.chrome.driver", "C:\\Users\\alistair\\IdeaProjects\\ProjectTeam1\\Generic\\driver\\chromedriver.exe");
                driver = new ChromeDriver();
            } else if (os.equalsIgnoreCase("mac")) {
                System.setProperty("webdriver.chrome.driver", "C:\\Users\\alistair\\IdeaProjects\\ProjectTeam1\\Generic\\driver\\chromedriver");
                driver = new ChromeDriver();
            }
        }
        if (browserName.equalsIgnoreCase("gecko")) {
            if (os.equalsIgnoreCase("windows")) {
                System.setProperty("webdriver.gecko.driver", "C:\\Users\\alistair\\IdeaProjects\\ProjectTeam1\\Generic\\driver\\geckodriver.exe");
                driver = new ChromeDriver();
            } else if (os.equalsIgnoreCase("mac")) {
                System.setProperty("webdriver.gecko.driver", "C:\\Users\\alistair\\IdeaProjects\\ProjectTeam1\\Generic\\driver\\geckodriver");
                driver = new ChromeDriver();
            }
        }
        ...
        if(browserName.equalsIgnoreCase("opera")){
            if (os.equalsIgnoreCase("windows")){
                System.setProperty("webdriver.opera.driver", "C:\\Users\\alistair\\IdeaProjects\\ProjectTeam1\\Generic\\driver\\operadriver.exe");
